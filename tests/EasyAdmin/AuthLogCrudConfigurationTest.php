...
#[RunTestsInSeparateProcesses] final class AuthLogCrudConfigurationTest extends AbstractWebTestCase
{
    private AuthLogCrudController $controller;

    public function testEntityFqcnConfiguration(): void
    {
        $this->assertEquals(
            AuthLog::class,
            AuthLogCrudController::getEntityFqcn()
        );
    }

    public function testControllerCanBeInstantiated(): void
    {
        $this->assertInstanceOf(AuthLogCrudController::class, $this->controller);
    }
    ...
    {
        $this->controller = self::getService(AuthLogCrudController::class);
    }
}
